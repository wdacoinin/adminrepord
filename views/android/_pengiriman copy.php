...
$columns = [
    ...
    [
        ...
        'value'=>function ($model, $key, $index, $widget) { //diffrent controller
            ...
            if(isset($_GET['divisi']) && $_GET['divisi'] <= 2){
            return 
            '<a class="btn btn-sm btn-primary modalButton" value="'. $ud . '"> <i class="align-middle" data-feather="edit"></i> '. $model->surat_jalan. '</a>
             <a class="btn btn-sm btn-secondary modalButton" value="'. $ud2 . '"> <i class="align-middle" data-feather="image"></i> Update Gambar</a>';
            }else{
                return '<a class="btn btn-sm btn-secondary modalButton" value="'. $af . '"> <i class="align-middle" data-feather="image"></i> Ambil Foto</a>';
            }
        },
        'hAlign'=>'center', 
        'vAlign'=>'middle',
