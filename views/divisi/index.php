    ...
    [
        ...
        'buttons'=>[
            'update' => function($url, $model) { 
                 ...
                 $ud = 'index.php?r=' . $controller->id . '/update&divisi=' . $model->divisi;
...
echo DynaGrid::widget([
    ...
    'gridOptions'=>[
        ...
        'panel'=>[
            'heading'=>'<h3 class="panel-title text-white"><i class="align-middle" data-feather="layers"></i>  Divisi</h3>',
            'before' =>  '<div style="padding-top: 7px;"><em>* Klik Tambah untuk buat Divisi</em></div>',
            'after' => false
        ],
        'toolbar' =>  [
            ['content'=>
            '<a class="btn btn-sm btn-success modalButton" value="'.Url::to(['create']).'"><i class="fas fa-plus"></i> Tambah Divisi</a>  ' .  
