...
[
    ...
    'buttons'=>[
        'update' => function($url, $model) { 
            //diffrent controller
            if($model->penjualan_produk_tt !== null){

            $ud = 'index.php?r=penjualan/updateproduktt&penjualan_produk_tt=' . $model->penjualan_produk_tt;
        ...
        //diffrent controller
            ...
            return '<a class="dropdown-item" href="'.Url::to(['penjualan/deleteproduktt', 'penjualan_produk_tt' => $model->penjualan_produk_tt]).'" title="Delete" aria-label="Delete" data-pjax="0" data-method="post" data-confirm="Are you sure to delete this item?" tabindex="-1"><i class="align-middle" data-feather="trash-2"></i> Delete</a>';
        },
    ],
    'dropdown'=>true,
...
echo DynaGrid::widget([
    ...
    'gridOptions'=>[
        ...
        'panel'=>[
            'heading'=>'<h3 class="panel-title text-white"><i class="align-middle" data-feather="shopping-bag"></i> Barang Tukar Tambah</h3>',
            'before' =>  '<div style="padding-top: 7px;"><em>* Klik Tambah untuk Produk</em></div>',
            'after' => false
        ],
        'toolbar' =>  [
            ['content'=>
            '<button class="btn btn-sm btn-success mr-2 modalButton3" value="'.Url::to(['penjualan/createproduktt', 'penjualan' => $penjualan]).'"><i class="fas fa-plus"></i> Tambah Produk</button>' .
