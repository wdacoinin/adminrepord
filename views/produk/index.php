...
$columns = [
    ...
    [
        ...
        'filter'=>ArrayHelper::map(KategoriT::find()->orderBy('kategori_nama ASC')->asArray()->all(), 'kategori_nama', 'kategori_nama'), 
        'filterWidgetOptions'=>[
    ...
    [
        ...
        'width'=>'150px',
        'filterType'=>GridView::FILTER_SELECT2,
        'filter'=>ArrayHelper::map(MerekT::find()->orderBy('nama ASC')->asArray()->all(), 'nama', 'nama'), 
        'filterWidgetOptions'=>[
            'pluginOptions'=>['allowClear'=>true],
        ],
        'filterInputOptions'=>['placeholder'=>'Pilih'],
    ...
    [
        ...
        'buttons'=>[
            'update' => function($url, $model) { 
                 ...
                 $ud = 'index.php?r=' . $controller->id . '/update&produk=' . $model->produk;
...
echo DynaGrid::widget([
    ...
    'gridOptions'=>[
        ...
        'panel'=>[
            'heading'=>'<h3 class="panel-title text-white"><i class="align-middle" data-feather="filter"></i> Produk</h3>',
            'before' =>  '<div style="padding-top: 7px;"><em>* Klik Tambah untuk buat Produk</em></div>',
            'after' => false
        ],
        'toolbar' =>  [
            ['content'=>
            '<a class="btn btn-sm btn-success modalButton" value="'.Url::to(['create']).'"><i class="fas fa-plus"></i> Tambah Produk</a>  ' . 
