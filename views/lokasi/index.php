...
$act = [
    ...
    'buttons'=>[
        'update' => function($url, $model) { 
             ...
             $ud = 'index.php?r=' . $controller->id . '/update&lokasi=' . $model->lokasi;
...
echo DynaGrid::widget([
    ...
    'gridOptions'=>[
        ...
        'toolbar' =>  [
            ['content'=>
            '<a class="btn btn-sm btn-success modalButton" value="'.Url::to(['create']).'"><i class="fas fa-plus"></i> Tambah Lokasi</a>  ' .  
