...
$columns = [
    ...
    [
        ...
        'filterWidgetOptions' => ([       
          ...
          'pluginEvents' => [
            "apply.daterangepicker" => "function() { apply_filter('timestamp') }",
          ],
        ]),
...
echo DynaGrid::widget([
    ...
    'gridOptions'=>[
        ...
        'panel'=>[
            'heading'=>'<h3 class="panel-title text-white"><i class="align-middle" data-feather="user-check"></i>  Konsumen</h3>',
            'before' =>  '<div style="padding-top: 7px;"><em>* Klik Tambah Konsumen</em></div>',
            'after' => false
        ],
        'toolbar' =>  [
            ['content'=>
            '<a class="btn btn-sm btn-success modalButton" value="'.Url::to(['create']).'"><i class="fas fa-plus"></i> Tambah Konsumen</a>  ' .  
    ...
    'options'=>['konsumen'=>'dynagrid-1'] // a unique identifier is important
]);
?>
