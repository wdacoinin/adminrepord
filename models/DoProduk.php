 ...
 */
class DoProduk extends DoProdukT
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['do_produk', 'do', 'stok_jenis', 'produk', 'do_jml', 'do_produk_status', 'jml_now'], 'integer'],
    ...
    {
        $query = DoProdukT::find()->orderBy(['produk' => SORT_ASC])->where(['do' => $do]);
