 ...
 */
class PenjualanOnNota extends PenjualanProdukT
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PenjualanProdukT::find()->where(['penjualan' => $penjualan]);
        ...
        //$query->orderBy($this->produk0->kategori0->kategori_urutan);
